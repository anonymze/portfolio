        ...
        <section>
          <motion.div
            ...
            transition={{ ease: "anticipate", duration: "0.8" }}  className="flex flex-wrap justify-center w-100">         
              <div className="relative flex m-10 w-2/5 bg-pink-600 rounded-lg transform transition-transform duration-200 ease-in-out hover:scale-105" style={{ minWidth: "800px", height: "500px", boxShadow: '0 4px 14px 0 var(--button-magenta)' }}>
              ...
              <Link href="https://github.com/anonymze/centralisation_laravel">
                <a target="_blank" className="flex m-10 w-2/5 bg-green-600 rounded-lg transform transition-transform duration-200 ease-in-out hover:scale-105" style={{ minWidth: "800px", height: "500px", boxShadow: '0 4px 14px 0 var(--button-green)' }}>
                  <div className="w-1/2 p-16">
