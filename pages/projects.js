        ...
        <section>
          <div className="flex flex-wrap justify-center w-100">
            <motion.div
              ...
              className="card relative flex m-10 w-2/5 bg-pink-600 rounded-lg transform transition-transform duration-200 ease-in-out hover:scale-105"
              style={{
                minWidth: "730px",
                height: "450px",
            ...
            >
              <Link href="https://github.com/anonymze/centralisation_laravel">
                <a
                  target="_blank"
                  className="flex h-full w-full bg-green-600 rounded-lg transform transition-transform duration-200 ease-in-out hover:scale-105"
                >
                  <div className="w-1/2 p-12 m-1">
